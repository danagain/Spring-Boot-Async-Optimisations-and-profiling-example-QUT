...
{   
    private static final char[] acids = {'A', 'R', 'N', 'D', 'C', 'Q', 'E', 'G', 'H', 'I', 'L', 'K', 'M', 'F', 'P', 'S', 'T', 'W', 'Y', 'V', 'B', 'Z', 'X', '*'};

    private static final int[][] raw_scores = {
    ...
    public synchronized static Matrix Load()
    {
