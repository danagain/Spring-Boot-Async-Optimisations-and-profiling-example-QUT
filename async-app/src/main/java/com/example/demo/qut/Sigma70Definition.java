...
class Sigma70Definition
{
    private synchronized static PWM getMinus10Pwm()
    {
    ...
    private synchronized static PWM getMinus35Pwm()
    {
        Alphabet alphabet = AlphabetDNA.instance();
        edu.au.jacobi.pattern.PWM pwm = new PWM(alphabet, 0.0);
    ...
    synchronized static Series getSeriesAll_Unanchored()
    {
        ...
        Series series = new SeriesAll(0.7);
        series.add(pwmM35);
        series.add(spacer);
        series.add(pwmM10);
        return series;
